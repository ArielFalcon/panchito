...
export async function publishContext(input: PublishInput, deps: PublishDeps): Promise<PublishResult | null> {
  ...
  return publishChanges(input, deps, {
    ...
    body: `FE↔BE architecture map generated by ai-pipeline for \`${input.sha}\`. Maps routes → API operations extracted from routing, OpenAPI specs, and generated API clients.`,
