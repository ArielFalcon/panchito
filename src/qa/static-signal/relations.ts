...
//               C3: heuristic resolution to Maven/Gradle layout paths added; raw
//               specifier kept when no matching file is found (fail-open).
//
// C3: TypeScript path alias resolution added. Reads tsconfig.json once per repoDir
    ...
    for (const file of langFiles) {
      try {
        ...
        for (const { specifier, names } of imports) {
          ...
          //   2. TypeScript path alias (@/... or custom prefix) — new for C3.
          //   3. Java dotted specifier heuristic — new for C3.
