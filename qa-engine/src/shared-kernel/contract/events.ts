// qa-engine/src/shared-kernel/contract/events.ts
...
//
// MOVED from src/contract/events.ts (Plan 7.3) — this file is now the canonical
// home; the legacy src/contract/events.ts re-exports from here during coexistence.
